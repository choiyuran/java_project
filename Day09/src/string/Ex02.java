...
public class Ex02 {
	public static void main(String[] args) {
		...
		String s1 = fileName.substring(5);			// 5부터 끝까지 잘라내기(5가 시작점, 5포함 마지막 문자열까지) -> substring(포함)
		String s2 = fileName.substring(0, 4);		// 0부터 4까지 잘라내기(4앞까지 뽑아오기)	-> substring(포함, 불포함)
